   ...
   <div className="text-center">
	...
	<div className="row justify-content-center text-center footer">
		<div className="col-md-2">
			<a className={mode?"contdark":"cont"} href="#" target="_blank"><i className="fa fa-facebook-official" aria-hidden="true"></i></a>
		</div>
		<div className="col-md-2"><a className={mode?"contdark":"cont"} href="https://www.instagram.com/" target="_blank"> <i className="fa fa-instagram" aria-hidden="true"></i></a></div>
		<div className="col-md-2"><a className={mode?"contdark":"cont"} href="https://www.behance.net/" target="_blank"><i className="fa fa-behance" aria-hidden="true"></i></a></div>
		<div className="col-md-2"><a className={mode?"contdark":"cont"} href="https://www.linkedin.com/in/prakash-pro" target="_blank"><i className="fa fa-linkedin" aria-hidden="true"></i></a></div>
		<div className="col-md-2"><a className={mode?"contdark":"cont"} href="#" target="_blank"><i className="fa fa-whatsapp" aria-hidden="true"></i></a></div>
		<div className="col-md-2"><a className={mode?"contdark":"cont"} href="https://github.com/prakashZip" target="_blank"><i className="fab fa-github"></i>
</a></div>
	</div>
</div>
        </>
